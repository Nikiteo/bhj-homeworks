...
const funcTimer = function () {
  ...
  if (content < 0) {
    ...
    content = 10; //как сделать тут зависимость, чтобы не было хардкодом записано, а выставлялось значение elemTimer.textContent повторно?
  }
};
setInterval(funcTimer, 500);
